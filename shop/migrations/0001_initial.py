    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        default="static/images/cart.png", upload_to="product-image/"
                    ),
                ),
                (
                    "slug",
                    models.SlugField(default=uuid.uuid1, max_length=255, unique=True),
                ),
                (
                    "category",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "variation",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="shop.variation"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "promotion",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="shop.promotion"
                    ),
                ),
            ],
        ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("product", "color"), name="unique_prod_color_combo"
            ),
        ),
        migrations.AddConstraint(

...
(function ($) {
	...
	/*-----------------------------------------
	 ...
	 minicart_dropdown();
	/*-----------------------------------------
	  6. Miniprofile Dropdown ---------------------
	  ------------------------------------------ */
	  function miniprofile_dropdown(){
		$(".site-header__profile").on("click", function(i) {
			i.preventDefault();
		...
		$("body").on("click", function(event ) {
		  var $target = $(event.target);
		  if(!$target.parents().is(".site-profile") && !$target.is(".site-profile")){
			$("body").find("#header-profile").slideUp();
		  }
		});
	  }
	 miniprofile_dropdown();
	/*-----------------------------------------
	  7. Sticky Header ------------------------
	  -----------------------------------------*/
